...
def compute_lane_from_candidates(line_candidates, img_shape):
    ...
    pos_lines = [l for l in line_candidates if
                 (l.slope > 0 and l.x2 > right_region_boundary) or (l.slope <= 0 and l.x1 > left_region_boundary)]
    neg_lines = [l for l in line_candidates if
                 (l.slope < 0 and l.x1 < left_region_boundary) or (l.slope >= 0 and l.x2 < right_region_boundary)]
